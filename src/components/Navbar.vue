<template>
  <nav
    class="fixed inset-x-0 top-0 z-30 mx-auto w-full max-w-5xl border border-red-200 bg-red-300 py-3 shadow backdrop-blur-lg md:top-6 md:rounded-xl lg:max-w-5xl"
  >
    <div class="flex">
